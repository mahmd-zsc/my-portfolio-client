...
function Page() {
  const { id: projectId } = useParams(); // الحصول على projectId من استعلامات URL باستخدام useParams
                ...
                <div className="table-auto w-full">
                  <div className="w-full overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                      <tbody>
                        <tr className="flex flex-col sm:flex-row gap-4 sm:gap-10 mb-10">
                          ...
                          <td className="flex flex-wrap gap-4 md:w-2/3">
                            {data.skills.map((s: any) => (
                              ...
                              >
                                <p
                                  className={`px-2 py-1 text-sm border border-black opacity-40 rounded-full hover:opacity-50 hover:scale-105 duration-300`}
                                >
                                  {s.title}
                                </p>
                              </a>
                        ...
                        <tr className="flex flex-col sm:flex-row gap-4 sm:gap-10">
                          <td className="text-gray-400 font-semibold py-2 pr-4 w-1/6">
                            Description
                          </td>
